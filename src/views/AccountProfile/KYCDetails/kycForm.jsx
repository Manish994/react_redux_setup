      ...
      <Grid item xs={12} sm={8}>
         <SubCard title="KYC Information" style={{ marginBottom: '24px' }}>
            <Grid container spacing={2}>
               ...
               <Grid item xs={12} sm={6} md={6}>
                  <FormControl fullWidth>
                     <TextField fullWidth label="Id Number" size="small" margin="normal" name="middleName" type="text" autoComplete="off" />
                  </FormControl>
               </Grid>
            </Grid>
            <Grid container spacing={2}>
               ...
               <Grid item xs={12} sm={6} sx={{ mt: 2 }}>
                  <FormControl fullWidth>
                     <Autocomplete
                        options={[]}
                        getOptionLabel={(option) => option.text}
                        renderInput={(params) => <TextField {...params} size="small" label="Issuing Authority" color="secondary" />}
                     />
                  </FormControl>
               </Grid>
               <Grid item xs={12} sm={6} md={6}>
         ...
         <SubCard title="Address Information" style={{ marginBottom: '24px' }}>
            ...
            <Grid container spacing={2}>
               <Grid item xs={12} sm={6} md={6}>
                  <FormControl fullWidth>
                     <TextField fullWidth label="Post Code" size="small" margin="normal" name="middleName" type="text" autoComplete="off" />
                  </FormControl>
               </Grid>
               <Grid item xs={12} sm={6} sx={{ mt: 2 }}>
                  <FormControl fullWidth>
